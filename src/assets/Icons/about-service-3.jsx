...
export const AboutServiceIcon3 = ({ width, height }) => {
  return (
    <svg
    ...
    >
      ...
      <circle cx="54.5" cy="38.5" r="14.5" fill="#FEF1C2"></circle>
      <path fill="url(#pattern0_2_14064)" d="M25 27H69V71H25z"></path>
      <defs>
        <pattern
          id="pattern0_2_14064"
          width="1"
        ...
        >
          <use transform="scale(.01)" xlinkHref="#image0_2_14064"></use>
        </pattern>
        <image
          id="image0_2_14064"
          width="100"
